...
bool SMB1_Compliance_To_SMB1::Save_Plugin_Settings() {
    ...
    if (!configFile.Set_Value("Worlds_Have_4_Levels", this->pluginSettings.worldsHave4Levels)) return false;
...
bool SMB1_Compliance_To_SMB1::Load_Plugin_Settings() {
    ...
    configFile.Get_Value("Worlds_Have_4_Levels", this->pluginSettings.worldsHave4Levels);
...
void SMB1_Compliance_To_SMB1::Load_Plugin_Default_Settings() {
    ...
    this->pluginSettings.worldsHave4Levels = false;
