...
private:
    ...
    const static int QUESTION_COIN =                                                                   1000;
    const static int QUESTION_MUSHROOM = QUESTION_COIN +                                                100;
    ...
    const static int PROBABILITY_TOTAL_SIMPLE = PROBABILITY_BRICK_WITH_1UP;
};
