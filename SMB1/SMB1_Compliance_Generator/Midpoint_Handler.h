...
public:
    Midpoint_Handler(Object_Writer *object, Continuous_Enemies_Spawner *continuousEnemiesSpawner, SMB1_Compliance_Generator_Arguments *args, Level_Type::Level_Type levelType);
