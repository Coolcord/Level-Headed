...
bool Island_Generator::Generate_Level() {
    ...
    if (!this->header->Write_Header_To_Buffer(Level_Type::ISLAND, Level_Attribute::OVERWORLD, this->levelCrawler->Get_Starting_Brick(), this->firstPageHandler->Get_Header_Background(), this->args->headerScenery, this->args->levelCompliment, 400,
