...
qint64 Level_Offset::Fix_Offset(qint64 offset) {
    ...
    case ROM_Type::COOP_CGTI_1:
        ...
        if (offset < 0x16D8) return offset + 0x7DF0;
        ...
        if (offset < 0x32DA) return offset + 0x7ECF;
        ...
        if (offset < 0x5169) return offset + 0x808F;
        if (offset < 0x536C) return offset + 0x8081;
        if (offset < 0x5373) return offset + 0x8081;
        ...
        if (offset < 0x69FD) return offset + 0x8202;
