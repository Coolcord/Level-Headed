...
bool Powerups::Replace_Fire_Flower_With_Cutter_Flower() {
    ...
    if (!this->Write_Bytes_To_Offset(0x61E2, QByteArray(1, 0x0D))) return false;
    if (!this->Write_Bytes_To_Offset(0x61F1, QByteArray(1, 0xFF))) return false;
...
bool Powerups::Replace_Fire_Flower_With_Double_Jump_Star() {
    ...
    if (!this->Write_Bytes_To_Offset(0x2F0F, QByteArray(1, 0x6E))) return false;
...
bool Powerups::Replace_Fire_Flower_With_Fire_Star() {
    if (!this->Write_Bytes_To_Offset(0x5F0, QByteArray(1, 0x05))) return false;
    ...
    if (!this->Write_Bytes_To_Offset(0x36C4, QByteArray(1, 0x06))) return false;
    if (!this->Write_Bytes_To_Offset(0x36D8, QByteArray(1, 0x02))) return false;
    if (!this->Write_Bytes_To_Offset(0x3CAD, QByteArray::fromHex(QString("EAEAEAEA").toLatin1()))) return false;
    if (!this->Write_Bytes_To_Offset(0x61F1, QByteArray(1, 0x05))) return false;
    if (!this->Write_Bytes_To_Offset(0x6208, QByteArray::fromHex(QString("EAEAEAEA").toLatin1()))) return false;
    if (!this->Write_Bytes_To_Offset(0x6410, QByteArray(1, 0x13))) return false;
    if (!this->Write_Bytes_To_Offset(0x66DF, QByteArray(1, 0x02))) return false;
    if (!this->Write_Bytes_To_Offset(0x6720, QByteArray::fromHex(QString("C901F0178500A5094A29030DCA03990202990602EA").toLatin1()))) return false;
...
bool Powerups::Replace_Fire_Flower_With_Poison_Bubbles() {
    if (!this->Write_Bytes_To_Offset(0x5F2, QByteArray(1, 0x12))) return false;
