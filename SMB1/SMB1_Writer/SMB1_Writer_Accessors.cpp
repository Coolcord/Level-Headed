...
bool SMB1_Writer::Music_Star_Remix() {
    if (!this->music) return false;
...
bool SMB1_Writer::Music_Super_Mushroom() {
    if (!this->music) return false;
    return this->music->Super_Mushroom();
}
...
bool SMB1_Writer::Music_U1_2() {
    if (!this->music) return false;
    return this->music->U1_2();
}

bool SMB1_Writer::Music_U1_3() {
    if (!this->music) return false;
    return this->music->U1_3();
}

bool SMB1_Writer::Music_U1_4() {
    if (!this->music) return false;
...
bool SMB1_Writer::Music_U1_8() {
    if (!this->music) return false;
    return this->music->U1_8();
}

bool SMB1_Writer::Music_U1_9() {
    if (!this->music) return false;
