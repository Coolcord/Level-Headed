...
cp -rf $SOURCE_LOCATION/Sequential_Archive/build-Sequential_Archive-Desktop-$MODE/libSequential_Archive.so $SOURCE_LOCATION/build-Sequential_Archive_Manager-Desktop-$MODE/Plugins/Sequential_Archive.so
